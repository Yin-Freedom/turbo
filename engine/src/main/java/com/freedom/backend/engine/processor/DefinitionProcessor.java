...
import com.freedom.backend.engine.common.FlowDefinitionStatus;
import com.freedom.backend.engine.common.FlowDeploymentStatus;
import com.freedom.backend.engine.common.FlowModuleEnum;
...
import com.freedom.backend.engine.exception.ParamException;
...
public class DefinitionProcessor {
    ...
    private void fillCommonResult(CommonResult commonResult, BaseException baseException) {
        fillCommonResult(commonResult, baseException.getErrNo(), baseException.getErrMsg());
    }

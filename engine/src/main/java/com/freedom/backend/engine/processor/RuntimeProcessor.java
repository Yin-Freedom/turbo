...
import com.freedom.backend.engine.bo.FlowInfo;
...
import com.freedom.backend.engine.common.FlowInstanceMappingType;
import com.freedom.backend.engine.common.FlowInstanceStatus;
import com.freedom.backend.engine.common.NodeInstanceStatus;
import com.freedom.backend.engine.common.ProcessStatus;
...
import com.freedom.backend.engine.exception.ReentrantException;
import com.freedom.backend.engine.exception.BaseException;
import com.freedom.backend.engine.executor.FlowExecutor;
...
import com.freedom.backend.engine.result.ElementInstanceListResult;
import com.freedom.backend.engine.result.FlowInstanceResult;
import com.freedom.backend.engine.result.InstanceDataListResult;
import com.freedom.backend.engine.result.NodeInstanceListResult;
import com.freedom.backend.engine.result.NodeInstanceResult;
...
import com.freedom.backend.engine.result.TerminateResult;
import com.freedom.backend.engine.service.FlowInstanceService;
import com.freedom.backend.engine.service.InstanceDataService;
...
import com.freedom.backend.engine.validator.ParamValidator;
...
public class RuntimeProcessor {
    ...
    private StartProcessResult buildStartProcessResult(RuntimeContext runtimeContext, BaseException e) {
        StartProcessResult startProcessResult = new StartProcessResult();
        BeanUtils.copyProperties(runtimeContext, startProcessResult);
    ...
    private CommitTaskResult buildCommitTaskResult(RuntimeContext runtimeContext, BaseException e) {
        CommitTaskResult commitTaskResult = new CommitTaskResult();
    ...
    private RollbackTaskResult buildRollbackTaskResult(RuntimeContext runtimeContext, BaseException e) {
        RollbackTaskResult rollbackTaskResult = new RollbackTaskResult();
    ...
    private RuntimeResult fillRuntimeResult(RuntimeResult runtimeResult, RuntimeContext runtimeContext, BaseException e) {
